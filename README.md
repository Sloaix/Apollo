...
```groovy
dependencies {
  compile "io.reactivex:rxandroid:2.0"//use the latest version
  compile "com.github.lsxiao.Apollo:core:1.0.0-alpha.2"
  annotationProcessor "com.github.lsxiao.Apollo:processor:1.0.0-alpha.2"
}
```
